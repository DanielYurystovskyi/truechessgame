	...
	*/
    public class FIDEnotation
    {
		...
		*/
        ...
        private static sbyte GetSbyteFromBlackPieceLetter(char letter)
        {
        ...
        private static ChessBoard PerformWhitePawnCapture(ChessBoard board, string notation, ChessBoard tempboard)
        {
            ...
            if (DefaultInfo.BlackEnPassantEndangered && enemyfile == DefaultInfo.EnPassantPossibleCapture.file && enemyrank == DefaultInfo.EnPassantPossibleCapture.rank)
            {
        ...
        {
            //simple move (not 4 rank) and promotion
            if (notation[1] != '4')
            {
